 ...
 */
public class NowJunitSenderTestGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        File f = new File(NowJunitSenderTestGenerator.class.getProtectionDomain().getCodeSource().getLocation()
                .getPath());
        ...
        if (args.length == 0) {
            ...
            absoluteTargetPath = path + "\\now-tls-generator-junit\\target\\generatedSendTests\\";
