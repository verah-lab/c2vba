...
/**
 *A class implement a {@link TimeSyncGenerator}
 * Object of this class can generate telegrams (better De blocks) with TLS time synchronisation
 */
...
public class GenericTimeSyncGenerator implements TimeSyncGenerator {
    ...
    public byte[] makeTimeSyncTele() {
        ...
        TlsETel etel = new TlsETel( null, 254, 2, 0 );
