...
@SpringBootTest(classes = DataChangeTestConfig.class, properties = {
        ...
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData0TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion0",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData1TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion1",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData2TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion2",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData3TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion3",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData4TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion4",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData5TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion5",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsData6TopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEErgebnisVersion6",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsSingleVehDataTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEKfzEinzeldaten",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsSingleVehCollectedDataTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEKfzEinzeldatenSammelmeldung",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsErrorTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEDeFehler",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsOperatingParamTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEBetriebsparameter",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsChannelControlTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-LVEKanalsteuerung",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsSysErrorTopicTemplate=DC-ALL-TEST-{centreTopic}-tlsin-SYSFehlerDUE",
        "de.heuboe.asfinag.vmis2.synchronize.vd.tlsTrafficCategoriesParamTopicTemplate=DC-ALL-TEST-{systemWideShortcut}-tlsout-LVEGeschwindigkeitsklassenKurzSoll",
        "de.heuboe.asfinag.vmis2.synchronize.vd.parameterSystemTopics[0]=DC-ALL-TEST-{systemWideShortcut}-Parameter-Zeitsynchronisation",
        "de.heuboe.asfinag.vmis2.synchronize.vd.parameterRoadTopics[0]=DC-ALL-TEST-{systemWideShortcut}-Parameter-LogischePassivierungVDE",
        "de.heuboe.asfinag.vmis2.synchronize.vd.dataChangeTopicTemplate=DC-ALL-TEST-{centreTopic}-DataChange",
        ...
        "de.heuboe.asfinag.vmis2.synchronize.vd.collectedDataLaneTopicTemplate=DC-ALL-TEST-{centreTopic}-ShortTermCollectedDataLane",
        "de.heuboe.asfinag.vmis2.synchronize.vd.collectedTrafficCategoriesLaneTopicTemplate=DC-ALL-TEST-{centreTopic}-ShortTermCollectedTrafficCategoriesLane",
        "de.heuboe.asfinag.vmis2.synchronize.vd.colletedOpcUaDataLaneTopicTemplate=DC-ALL-TEST-{centreTopic}-ShortTermCollectedOpcUaDataLane",
        "de.heuboe.asfinag.vmis2.synchronize.vd.discardedDataLaneTopicTemplate=DC-ALL-TEST-{centreTopic}-DiscardedShortTermCollectedDataLane",
        "de.heuboe.asfinag.vmis2.synchronize.vd.topicTmpltControlSequence=DC-ALL-TEST-{systemWideShortcut}-tlsout-SYSSteuerSequenz",
...
@EmbeddedKafka(partitions = 1,
    ...
    topics = {
        "DC-ALL-TEST-VRZ-Parameter-LogischePassivierungVDE",
        "DC-ALL-TEST-VRZ-Parameter-Zeitsynchronisation",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion0",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion1",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion2",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion3",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion4",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion5",
        "DC-ALL-TEST-WIE-tlsin-LVEErgebnisVersion6",
        "DC-ALL-TEST-WIE-tlsin-LVEKfzEinzeldaten",
        "DC-ALL-TEST-WIE-tlsin-LVEKfzEinzeldatenSammelMeldung",
        "DC-ALL-TEST-WIE-tlsin-LVEDeFehler",
        "DC-ALL-TEST-WIE-tlsin-LVEBetriebsparameter",
        "DC-ALL-TEST-WIE-tlsin-LVEKanalsteuerung",
        "DC-ALL-TEST-WIE-tlsin-SYSFehlerDUE",
        "DC-ALL-TEST-VRZ-tlsout-LVEGeschwindigkeitsklassenKurzSoll",
        "DC-ALL-TEST-WIE-ShortTermCollectedDataLane",
        "DC-ALL-TEST-WIE-ShortTermCollectedTrafficCategoriesLane",
        "DC-ALL-TEST-WIE-ShortTermCollectedOpcUaDataLane",
        "DC-ALL-TEST-WIE-DiscardedShortTermCollectedDataLane",
        "DC-ALL-TEST-VRZ-tlsout-SYSSteuerSequenz",
        "DC-ALL-TEST-WIE-DataChange"
    }
)
...
@Slf4j
public class DataChangeAllTest {
    ...
    // EXPECTED_RESULT_SIZE_VDE_UPDATE is the number of VDE_SENSORs after DataChange
    private final static int EXPECTED_RESULT_SIZE_VDE_UPDATE = 7;

    private static final String TEST_COLLECTED = "DC-ALL-TEST-WIE-ShortTermCollectedDataLane";
...
//                .build()).get();
    ...
    void testFullCycle() throws IOException, InterruptedException, ExecutionException {
        ...
        log.info("TEST: check if first set of data is processed; expected result size: {}",
                EXPECTED_RESULT_SIZE);
        checkA23Data(now, EXPECTED_RESULT_SIZE);

        // Create a new config trigger with allChanged flag = true. Implicitly, it is a change to
        // A23 with fewer VDE sensors, just like in the original DataChangeTest
        log.info("Sent DataChange with changed allChanged=true ...");
        Thread.sleep(3000);
        PDataChanges pDataChanges = PDataChanges.builder().iid("IID124").allChanged(true)
                .version("cfgAllUpdate").mapVersion("mapAllUpdate").build();

        TestUtils.updateType = TestUtils.UpdateType.UPDATE;
        kafkaTemplate.send(MessageBuilder.withPayload(pDataChanges).setHeader(KafkaHeaders.TOPIC, "DC-ALL-TEST-WIE-DataChange")
                .setHeader(KafkaHeaders.KEY, "Trigger").build()).get();

        Thread.sleep(90000);
        log.info("TEST: check if second set of data is processed; expected result size: {}",
                EXPECTED_RESULT_SIZE_VDE_UPDATE);
