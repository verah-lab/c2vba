 ...
 */
public class Vmis2JunitReceiverTestGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        File f = new File(Vmis2JunitReceiverTestGenerator.class.getProtectionDomain().getCodeSource().getLocation()
                .getPath());
        ...
        if (args.length == 0) {
            ...
            absoluteTargetPath = path + "\\vmis2-tls-generator-junit\\target\\generatedRcvTests\\";
