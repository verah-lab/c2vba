package de.heuboe.asfinag.vmis2.tls.scripts.tests.receiver;

import de.heuboe.asfinag.vmis2.tls.scripts.tests.Vmis2TestBase;
...
public class FgCustomReceiverTests extends Vmis2TestBase {
