package de.heuboe.asfinag.vmis2.tls.scripts.tests.sender;

import com.fasterxml.jackson.core.JsonParseException;
import com.fasterxml.jackson.databind.JsonMappingException;
import de.heuboe.asfinag.vmis2.tls.scripts.tests.Vmis2SenderTestTransformer;
...
public class FgCustomSenderTests {
    ...
    public static void setUp() throws JsonParseException, JsonMappingException, IOException {
        transformer = new Vmis2SenderTestTransformer();
    }
