...
/**
 * Variable sign generator (specification term: "Wechselzeichengeber")
 * 
 * @author David Hermanns, Heusch/Boesefeldt GmbH, david.hermanns@heuboe.de; 24.11.2020
 *
 */
@NoArgsConstructor
public class VsgSensor extends InfrastructureObjectBase {

    /**
     * Constructs a variable sign generator infrastructure object.
     * 
     ...
     */
    public VsgSensor(String id, String name, String shortName, String version, GeoReference geoReference,
            Map<String, List<InfrastructureObject>> references, Map<String, Object> attachedData) {
        super(id, name, shortName, version, geoReference, ReferenceTypes.VSG_SENSOR, references, attachedData);
    }
