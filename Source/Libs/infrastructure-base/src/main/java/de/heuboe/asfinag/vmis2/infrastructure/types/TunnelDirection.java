 ...
 */
@NoArgsConstructor
public class TunnelDirection extends InfrastructureObjectBase {
     ...
     */
    public TunnelDirection(String id, String name, String shortName, String version, GeoReference geoReference,
            Map<String, List<InfrastructureObject>> references, Map<String, Object> attachedData) {
        super(id, name, shortName, version, geoReference, "TunnelDirection", references, attachedData);
    }
