...
/**
 * Trigger time synchronisation
 * "Prüffall 6:  Triggern der Zeitsynchronisation"
 *
 * Objective: Trigger time synchronisation<br>
 * Description: Time synchronisation should be triggered if received data are out of defined timeslot.<br>
 * Precondition: Infrastructure is filled, algorithm and infrastructure parameter are set<br>
 * Requirements:
 */
@SuppressWarnings("unchecked")
public class TC6_TimeSynchronisationTest {
    
    private static final Logger LOG = LoggerFactory.getLogger(TC6_TimeSynchronisationTest.class);
    ...
    public TC6_TimeSynchronisationTest() {
    ...
    public void testCompleteness() {
        ...
        testStep6(time1330, time1345, time1415);
    }
    ...
    /**
     * Test step 3: missing 2 interval 30 values coming in at second 40. Publish interval 30.
     * @param eventtime30
    ...
    /**
     * Test step 6: timeout end for interval 15 an 30 reached. No more publish.
     * 
     * @param intervalEnd
     * @param timeoutEnd
     */
    public void testStep6(Instant eventtime, Instant intervalEnd, Instant processingTime) {
        List<Object> builders = new ArrayList<>();
        ...
        //Time synchronization should be published
