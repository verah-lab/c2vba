...
public class TC9_ChangeIntervalLengthTest {
    
    private static final Logger LOG = LoggerFactory.getLogger(TC9_ChangeIntervalLengthTest.class);
    ...
    public TC9_ChangeIntervalLengthTest() {
    ...
    public void testStep1(Instant eventtime, Instant processingTime) {
        ...
        setIntervalData(algo, builders, eventtime, processingTime);
    }
    ...
    private static void setIntervalData(SyncVdAlgo<AbstractData> algo,
        ...
        dataBuilders.forEach(b -> {
            inputData.add(TCUtils.switchByClassType(b, eventtime, processingTime));
        });
        //Data
