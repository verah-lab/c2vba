 ...
 * "Prüffall 5: Test auf Vollständigkeit"
 *
...
public class TC5_CompletenessCommProbTest {
    
    private static final Logger LOG = LoggerFactory.getLogger(TC5_CompletenessCommProbTest.class);
    ...
    public TC5_CompletenessCommProbTest() {
    ...
    public void testCompleteness() {
        ...
        mockClock.advanceBySeconds(9);
        Instant time1309 = Instant.now(mockClock);      // 14:13:09
        LOG.debug("---------------------------- " + DTF.format(time1309) +" -----------------------------");
        testStep2(time1245, time1309);
    ...
    public void testStep5(Instant eventtime, Instant intervalEnd) {
        ...
        //InfraStates
        algo.setInfraState(infraStates);        algo.intervalEndTrigger(intervalEnd, Arrays.asList(secondsI15));
        ArgumentCaptor<List<AbstractData>> argInput = ArgumentCaptor.forClass(List.class);
        ArgumentCaptor<List<Tuple3<String, Instant, Integer>>> argMissingIds = ArgumentCaptor.forClass(List.class);  
        ArgumentCaptor<Map<String, InfraParameter>> infraPara = ArgumentCaptor.forClass(Map.class);
        ArgumentCaptor<Map<String, InfraState>> infraStatesArg = ArgumentCaptor.forClass(Map.class);
