...
public class TestTlsInputData extends AbstractData {
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion0 inputData) {
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion1 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion2 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
                IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()) != null
                        ? IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()).getSeconds()
                        : null,
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion3 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
                IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()) != null
                        ? IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()).getSeconds()
                        : null,
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion4 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
                IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()) != null
                        ? IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()).getSeconds()
                        : null,
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion5 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
                IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()) != null
                        ? IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()).getSeconds()
                        : null,
     ...
     */
    public TestTlsInputData(PLVEErgebnisVersion6 inputData) {
        super(inputData.getId(), inputData.getTlsTime(), inputData.getProcessTime(),
                IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()) != null
                        ? IntervalLengthValue.getIntervalLengthValue(inputData.getIntervalllaenge()).getSeconds()
                        : null,
