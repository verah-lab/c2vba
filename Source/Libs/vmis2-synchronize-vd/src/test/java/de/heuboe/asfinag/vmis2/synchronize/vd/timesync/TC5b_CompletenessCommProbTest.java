 ...
 * Description: The received values are not published, until all measurement point sent data for an
...
public class TC5b_CompletenessCommProbTest {

    private static final Logger LOG = LoggerFactory.getLogger(TC5b_CompletenessCommProbTest.class);
    ...
    public TC5b_CompletenessCommProbTest() {
    ...
    public void testStep2(Instant eventtime, Instant processingTime) {
        ...
        assertTrue(argMissingIds.getValue().contains(new Tuple3<String, Instant, Integer>(id_72,
                eventtime.plusSeconds(secondsI15), secondsI15)));
    }
    ...
    public void testStep8(Instant eventtime30, Instant processingTime) {
        ...
        assertTrue(argMissingIds.getValue().contains(new Tuple3<String, Instant, Integer>(id_75, eventtime30.plusSeconds(secondsI30), secondsI30)));
    }
