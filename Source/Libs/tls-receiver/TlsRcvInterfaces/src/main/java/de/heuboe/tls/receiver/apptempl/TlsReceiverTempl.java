package de.heuboe.tls.receiver.apptempl;
 ...
 *
 */
public class TlsReceiverTempl {

//	private static final Logger LOGGER = Logger.getLogger(TlsReceiverTempl.class);
	...
	private TransformationRulesContainer transformationRules;
	 ...
	 */
	public TlsReceiverTempl(AddressConverter addressConverter,
    ...
    public void init() throws IOException {
        if ( null == smm ) {
//            LOGGER.warn( "No SystemMessageManagement given!" );
        }
        transformationRules = transformationReader.createTransformationRules( specFile, smm );
...
//                                LOGGER.warning( "Telegram transformed to null. Probably an error within. Skipped!" );
                                ...
                                if (null != smm) {
                                    smm.sendMessage( "Telegram transformed to null. Probably an error within. Skipped!" );
                                }
                                
                                continue;
                            }
//                            LOGGER.debug( "tele transformed to " + objList.size() + " objects" );
                            for ( DataObjectIf obj : objList ) {
...
//                    LOGGER.fatal( "TlsReceiver: " + e );
                    ...
                    if (null != smm) {
                        smm.sendMessage( "TlsReceiver: " + e.toString() );
                    }
    ...
    public TransformationRulesContainer getTransformationRules() {
