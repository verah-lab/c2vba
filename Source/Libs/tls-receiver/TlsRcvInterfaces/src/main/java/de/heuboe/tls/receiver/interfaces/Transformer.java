...
public interface Transformer {
         ...
         *                The address converter to be used Sets the address converter to be used
         */
        public void setAddressConverter( AddressConverter addressConverter );

        /**
         * @param transformationRules
         *                The transformation rules to be used Set the the transformation rules to be used
         */
        public void setTransformationRules( TransformationRulesContainer transformationRules );
        
        /**
         * @param timezoneId the time zone to apply to analysis when the current time is taken 
         */
         ...
         * 
         * @param behaviour
         *                The behaviour to be applied to the transformation process
         */
        public void init( Behaviour behaviour );

        /**
         * @param tlsTele
         *                The telegram to be analysed (Sammeltelegramm)
         * @return A List of DataObjects This call decomposes a telegram into its parts. The transformation rules and the address converter are involved to do
         *         the analysis
         */
        ...
        public static class Behaviour {
                ...
                private boolean addMissingTimestamp = true;
                ...
                /**
                 * State of handling of missing timestamps
                 * @return The current state whether timestamps are to be added if the are missing in the telegram
                 */
                public boolean isAddMissingTimestamp() {
                        return addMissingTimestamp;
                }

                /**
                 * Turn on or off the provisioning of missing timestamps
                 * @param addMissingTimestamp new state of supplementing missing timestamps
                 */
                public void setAddMissingTimestamp( boolean addMissingTimestamp ) {
                        this.addMissingTimestamp = addMissingTimestamp;
                }
