...
statement : deblockdef | locationList;
...
getter :  intGetter			// a get for integer values 
		...
		| arrayGetter 		// a getter for arrays of any kind
		| arrayGetter2 		// a getter for arrays of any kind
		| stringGetter 		// a getter for strings
		| blockGetter 		// a getter for byte arrays (block)
