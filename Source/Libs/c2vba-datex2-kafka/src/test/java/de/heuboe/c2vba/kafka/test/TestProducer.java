...
public class TestProducer extends BaseT {
	...
	@Test
	public void testProducer() throws IOException, C2VbaException, JAXBException, KafkaException {
		
		Set<String> keys = kafkaManager.getAllKeysProto( DatexIIContent.class, producer.getTopic(), 5000L );
		...
		String xml = FileUtils.readFileToString( new File("D:\\c2vba\\vms\\vms-sued.xml"), StandardCharsets.UTF_8 );
