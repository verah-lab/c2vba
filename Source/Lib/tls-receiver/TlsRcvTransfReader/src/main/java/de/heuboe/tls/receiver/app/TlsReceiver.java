...
public class TlsReceiver {
	...
	private static final Logger LOGGER = LogManager.getLogger(TlsReceiver.class);
    ...
    /**
     * Allow the thread invoked by the init method to be stopped. Stooping is only possible after the next receipt of a telegram. But this receive action may
