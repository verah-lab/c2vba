...
echo "Applying c2vba-datex2-join-www"
kubectl apply -f c2vba-datex2-join-www-service.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-www-deployment.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-www-pvc.yaml -n ${NAMESPACE}
