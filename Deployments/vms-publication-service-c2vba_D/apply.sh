...
kubectl apply -f vms-publication-service-service.yaml -n ${NAMESPACE}
kubectl apply -f vms-publication-service-environment.yaml -n ${NAMESPACE}
kubectl apply -f vms-publication-service-deployment.yaml -n ${NAMESPACE}
# kubectl apply -f vms-publication-service-pvc.yaml -n ${NAMESPACE}
