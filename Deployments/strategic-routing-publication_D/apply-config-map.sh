...
echo "Applying strategic-routing-publication configs"
kubectl create cm strategic-routing-publication -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
