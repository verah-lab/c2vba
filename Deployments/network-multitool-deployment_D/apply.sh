...
echo "Applying network-multitool-deployment"
kubectl apply -f network-multitool-deployment.yaml -n ${NAMESPACE}
kubectl apply -f network-multitool-pvc.yaml -n ${NAMESPACE}
