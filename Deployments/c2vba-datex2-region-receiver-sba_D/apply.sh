...
echo "Applying c2vba-datex2-region-receiver-sba"
kubectl apply -f c2vba-datex2-region-receiver-sba-service.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-region-receiver-sba-deployment.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-region-receiver-sba-pvc.yaml -n ${NAMESPACE}
