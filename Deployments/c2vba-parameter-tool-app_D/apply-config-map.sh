...
echo "Applying c2vba-parameter-tool-app configs"
kubectl create cm c2vba-parameter-tool-app -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
