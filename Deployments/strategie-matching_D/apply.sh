...
kubectl apply -f strategie-matching-service.yaml -n ${NAMESPACE}
kubectl apply -f strategie-matching-deployment.yaml -n ${NAMESPACE}
kubectl apply -f strategie-matching-pvc.yaml -n ${NAMESPACE}
