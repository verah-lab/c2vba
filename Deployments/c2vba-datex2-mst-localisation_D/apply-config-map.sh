...
echo "Applying c2vba-datex2-mst-localisation configs"
kubectl create cm c2vba-datex2-mst-localisation -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
