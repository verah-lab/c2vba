...
kubectl apply -f vms-status-publication-service.yaml -n ${NAMESPACE}
kubectl apply -f vms-status-publication-deployment.yaml -n ${NAMESPACE}
kubectl apply -f vms-status-publication-pvc.yaml -n ${NAMESPACE}
