...
echo "Applying c2vba-datex2-region-receiver-www configs"
kubectl create cm c2vba-datex2-region-receiver-www -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
