...
else                         NAMESPACE=vmis2; export NAMESPACE   # fallback
fi

echo "Waiting for completion of tls-ifacetlsoip-a3"
kubectl rollout status -f tls-ifacewancom-deployment.yaml -n ${NAMESPACE}
