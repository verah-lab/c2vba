...
echo "Applying c2vba-datex2-region-receiver configs"
kubectl create cm c2vba-datex2-region-receiver -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
