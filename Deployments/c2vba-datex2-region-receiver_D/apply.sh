...
echo "Applying c2vba-datex2-region-receiver"
kubectl apply -f c2vba-datex2-region-receiver-service.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-region-receiver-deployment.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-region-receiver-pvc.yaml -n ${NAMESPACE}
