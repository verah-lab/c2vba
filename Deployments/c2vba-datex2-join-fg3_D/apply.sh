...
echo "Applying c2vba-datex2-join-fg3"
kubectl apply -f c2vba-datex2-join-fg3-service.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-fg3-deployment.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-fg3-pvc.yaml -n ${NAMESPACE}
