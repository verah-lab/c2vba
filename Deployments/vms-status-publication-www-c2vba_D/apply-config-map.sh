...
echo "Applying vms-status-publication-www configs"
kubectl create cm vms-status-publication-www -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
