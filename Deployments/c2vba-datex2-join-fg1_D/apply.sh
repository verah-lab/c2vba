...
echo "Applying c2vba-datex2-join-fg1"
kubectl apply -f c2vba-datex2-join-fg1-service.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-fg1-deployment.yaml -n ${NAMESPACE}
kubectl apply -f c2vba-datex2-join-fg1-pvc.yaml -n ${NAMESPACE}
