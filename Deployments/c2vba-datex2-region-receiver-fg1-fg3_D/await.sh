...
echo "Waiting for completion of c2vba-datex2-region-receiver-fg1-fg3"
kubectl rollout status -f c2vba-datex2-region-receiver-fg1-fg3-deployment.yaml -n ${NAMESPACE}
