...
echo "Applying c2vba-datex2-region-receiver-fg1-fg3 configs"
kubectl create cm c2vba-datex2-region-receiver-fg1-fg3 -n ${NAMESPACE} --from-file=configs --dry-run=true -o yaml > config.yaml
